...
{{ Form::open(['url' => route('signin'), 'method' => 'post', 'autocomplete' => 'off']) }}
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        ...
        <div class="form-group">
            {{ Form::submit('Войти', ['class' => 'btn btn-inline btn-link']) }}
            {{ link_to_route('remind', '?', null, ['class' => 'btn btn-remember btn-inline btn-link hint-tooltip', 'data-placement' => 'right', 'title' => 'Я забыл пароль :(']) }}
        </div>
    </div>
